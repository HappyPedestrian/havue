    ...
    <div class="container">
      ...
      >
        <div
          ...
          data-depth="1.2"
          style="
            transform: translate3d(-133.3px, -1.3px, 0px);
            transform-style: preserve-3d;
            backface-visibility: hidden;
            position: relative;
            display: block;
        ...
        <div
          ...
          data-depth="0.9"
          style="
            transform: translate3d(-100px, -1px, 0px);
            transform-style: preserve-3d;
            backface-visibility: hidden;
            position: absolute;
            display: block;
        ...
        <div
          ...
          data-depth="0.60"
          style="
            transform: translate3d(-66.7px, -0.7px, 0px);
            transform-style: preserve-3d;
            backface-visibility: hidden;
            position: absolute;
            display: block;
        ...
        <div
          ...
          data-depth="0.40"
          style="
            transform: translate3d(-44.4px, -0.4px, 0px);
            transform-style: preserve-3d;
            backface-visibility: hidden;
            position: absolute;
            display: block;
        ...
        <p
          ...
          data-depth="0.50"
          style="
            transform: translate3d(-55.6px, -0.6px, 0px);
            transform-style: preserve-3d;
            backface-visibility: hidden;
            position: absolute;
            display: block;
        ...
        <p
          ...
          data-depth="0.10"
          style="
            transform: translate3d(-11.1px, -0.1px, 0px);
            transform-style: preserve-3d;
            backface-visibility: hidden;
            position: absolute;
            display: block;
      ...
      <div class="text">
        <article>
          ...
          <a href="/" class="btn" target="_self">返回首页</a>
        </article>
      </div>
    </div>
  </section>
...
.wrapper .container .text article .btn {
  display: block;
  line-height: 40px;
  height: 40px;
  padding: 0 30px;
...
.wrapper .container .text article .btn:hover {
