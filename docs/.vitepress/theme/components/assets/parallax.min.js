          ...
          var o = (function () {
            ...
            a = {
              ...
              deserialize: function (t) {
                return (
                  'true' === t ||
                  ('false' !== t && ('null' === t ? null : !isNaN(parseFloat(t)) && isFinite(t) ? parseFloat(t) : t))
                )
              },
              ...
              transformSupport: function (t) {
                for (
                  ...
                  if (
                    (null !== a.vendors[l]
                      ? ((s = a.vendors[l][0] + 'transform'), (r = a.vendors[l][1] + 'Transform'))
                  ...
                  case '3D':
                    if (i) {
                      ...
                      document.body ||
                        ...
                        (o =
                          void 0 !== (n = window.getComputedStyle(e).getPropertyValue(s)) &&
                          n.length > 0 &&
                          'none' !== n),
                        (c.style.overflow = d),
                        u.removeChild(e),
              ...
              css: function (t, e, i) {
                ...
                if (!n)
                  for (var o = 0, s = a.vendors.length; o < s; o++)
                    if (
                      ((n = null !== a.vendors[o] ? a.camelCase(a.vendors[o][1] + '-' + e) : e), void 0 !== t.style[n])
                    ) {
                      a.propertyCache[e] = n
                      break
                    }
                ...
                o(t, [
                  {
                    ...
                    value: function () {
                      void 0 === this.transform2DSupport &&
                        ...
                        'static' === window.getComputedStyle(this.element).getPropertyValue('position') &&
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      ;(Math.abs(t) > this.calibrationThreshold || Math.abs(e) > this.calibrationThreshold) &&
                        ...
                        isNaN(parseFloat(this.limitX)) ||
                          (this.motionX = a.clamp(this.motionX, -this.limitX, this.limitX)),
                        isNaN(parseFloat(this.limitY)) ||
                          (this.motionY = a.clamp(this.motionY, -this.limitY, this.limitY)),
                    ...
                    value: function (t, e) {
                      ...
                      this.portrait !== o && ((this.portrait = o), (this.calibrationFlag = !0)),
                        this.calibrationFlag &&
                          ((this.calibrationFlag = !1), (this.calibrationX = i), (this.calibrationY = n)),
                        (this.inputX = i),
                        (this.inputY = n)
                    }
                  },
                    ...
                    value: function (t) {
                      ...
                      this.relativeInput
                        ? (this.clipRelativeInput &&
                          ...
                          this.elementRangeX &&
                            this.elementRangeY &&
                            ((this.inputX = (e - this.elementPositionX - this.elementCenterX) / this.elementRangeX),
                            (this.inputY = (i - this.elementPositionY - this.elementCenterY) / this.elementRangeY)))
                        : this.windowRadiusX &&
                          this.windowRadiusY &&
                          ((this.inputX = (e - this.windowCenterX) / this.windowRadiusX),
